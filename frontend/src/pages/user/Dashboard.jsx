...
const VARIETIES = [
  ...
  {
    name: "Pepperoni",
    desc: "Loaded with pepperoni slices",
    price: 349,
    emoji: "🍕",
  },
  {
  ...
  {
    name: "Veggie Supreme",
    desc: "Garden fresh veggies",
    price: 299,
    emoji: "🥗",
  },
  {
    name: "Four Cheese",
    desc: "A celebration of cheeses",
    price: 449,
    emoji: "🧀",
  },
];
          ...
          {VARIETIES.map((pizza) => (
            ...
            >
              ...
              <div className="flex justify-between items-center">
                <p className="text-pizza-red font-bold text-xl">
                  ₹{pizza.price}
                </p>
                <button
